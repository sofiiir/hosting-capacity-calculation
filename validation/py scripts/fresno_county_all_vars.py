...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("outputs/host_cap_run_all_fresno.log"),
...
pge_circuits = pge_circuits[pge_circuits['FeederName'] == "AIRWAYS 1103"]
...
linked.to_parquet("../../../../../../capstone/electrigrid/data/fresno_all.parquet")
linked_clean.to_parquet("../../../../../../capstone/electrigrid/data/fresno_clean_all.parquet")
